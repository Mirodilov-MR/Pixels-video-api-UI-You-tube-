...
public class FragmentSearchBindingImpl extends FragmentSearchBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(1, 
            new String[] {"app_bar"},
            new int[] {2},
            new int[] {com.ytp.pixe.R.layout.app_bar});
        sViewsWithIds = new android.util.SparseIntArray();
        sViewsWithIds.put(R.id.rvVideos, 3);
    }
    // views
    @NonNull
    ...
    private FragmentSearchBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (com.ytp.pixe.databinding.AppBarBinding) bindings[2]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeAppBar((com.ytp.pixe.databinding.AppBarBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeAppBar(com.ytp.pixe.databinding.AppBarBinding AppBar, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
