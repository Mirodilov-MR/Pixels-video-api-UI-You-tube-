 ...
 */
public abstract class Hilt_Videos extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Videos(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Videos_GeneratedInjector) this.generatedComponent()).injectVideos(UnsafeCasts.<Videos>unsafeCast(this));
    }
  }
